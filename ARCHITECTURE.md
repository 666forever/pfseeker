...
Submission and admin routes are future phases and must not be built as decorative dead screens before their backing behavior exists. The current account route shows truthful Discord identity and local session information only.
