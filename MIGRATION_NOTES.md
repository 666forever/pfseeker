...
- Phase 11 authenticated multiple collections are complete and production-verified. Phase 12 signed pending submissions are implemented and merged. Migrations `0004_signed_submissions.sql` and `0005_optional_submission_taxonomy.sql` support pending submissions with optional taxonomy. Signed-out route protection has been manually verified. Production runtime upload verification remains pending until the optional-taxonomy fix is deployed and manually tested. Phase 13 moderation has not started.
